...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tcKimlikOnYuz = findViewById(R.id.tcKimlikOnYuz);
        ...
        devamEtBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bitmap bitmap = ((BitmapDrawable) tcKimlikOnYuz.getDrawable()).getBitmap();
                ...
                Volley.newRequestQueue(MainActivity4.this).add(request);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 100 && resultCode == RESULT_OK) {
            ...
            if (originalBitmap != null) {
                ...
                // ImageView'a ayarla
                tcKimlikOnYuz.setImageBitmap(scaledBitmap);
